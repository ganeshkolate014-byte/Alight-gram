...
const UploadModal: React.FC<UploadModalProps> = ({ currentUser, onClose, onUploadSuccess }) => {
  ...
  const handleUpload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Animate out before calling success
      setIsVisible(false);
      setTimeout(() => {
        onUploadSuccess();
      }, 300);
      ...
      >
        ...
        <div className="overflow-y-auto p-4 custom-scrollbar bg-ios-bg">
          ...
          <form className="space-y-6 pb-10">
            ...
            {/* Files Group */}
            <div>
                 <h3 className="text-xs font-medium text-ios-labelSecondary uppercase ml-4 mb-2">Assets</h3>
            ...
            <p className="text-xs text-center text-ios-labelSecondary px-4">
                By posting, you agree to share this content under the community guidelines.
            </p>
          </form>
        </div>
      </div>
